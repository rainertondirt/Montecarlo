				...
				<div class="panel-body">
					<ul class="nav nav-tabs">
			  			 ...
			  			 <div class="tab-content">
								...
								<div id="tentang" class="tab-pane fade" style="padding-top: 20px;">
										<p>Distributed by <a href="https://blogbugabagi.blogspotcom" target="_blank" rel="noopener noreferrer">BlogBugaBagi</a></p>
										<p>Developed by <a href="https://github.com/trisamsul/" target="_blank" rel="noopener noreferrer">Kelompok 2 Tri Samsul</a></p>
						    	</div>
						 </div>
		   		</div>
		   	</div>
